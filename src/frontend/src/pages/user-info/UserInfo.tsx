...
const rows: GridRowsProp = [
  ...
  { id: 10, 닉네임: "닉네임", 아이디: "아이디", 이메일: "이메일", "구독 여부": "구독 여부", 성별: "성별", 언어: "언어" },
  { id: 11, 닉네임: "닉네임", 아이디: "아이디", 이메일: "이메일", "구독 여부": "구독 여부", 성별: "성별", 언어: "언어" },
  { id: 12, 닉네임: "닉네임", 아이디: "아이디", 이메일: "이메일", "구독 여부": "구독 여부", 성별: "성별", 언어: "언어" },
  { id: 13, 닉네임: "닉네임", 아이디: "아이디", 이메일: "이메일", "구독 여부": "구독 여부", 성별: "성별", 언어: "언어" },
];

const columns: GridColDef[] = [
  { field: "닉네임", headerName: "닉네임", width: 110 },
  { field: "아이디", headerName: "아이디", width: 110 },
  { field: "이메일", headerName: "이메일", width: 150 },
  { field: "구독 여부", headerName: "구독 여부", width: 150 },
  { field: "성별", headerName: "성별", width: 180 },
  { field: "언어", headerName: "언어", width: 250 },
  {
    field: "자세히보기",
    headerName: "자세히보기",
    width: 100,
